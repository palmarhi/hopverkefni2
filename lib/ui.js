...
import { fetchTodos, updateTodo } from './todos.js';
...
export async function fetchAndRenderTodos(container) {
  ...
  addButton.addEventListener('click', function() { breytaOgBaetaMenu(todosIndex, createNewTask) });
...
function fetchAndRenderTodo(todo, parent) {
  ...
  checkbox.addEventListener('click', function(e) { changeStatus(e, todo); });
